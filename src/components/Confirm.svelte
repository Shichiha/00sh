<script lang="ts">
	...
	onMount(() => {
		...
		document.addEventListener('click', (e) => {
			if ((e.target as Element)?.classList.contains('bg-black/50')) show = false;
		});
	});
</script>
...
{#if show}
	<div
		class="bg-black/50 flex items-center justify-center h-full fixed top-0 left-0 w-full z-10"
		transition:fade
	>
